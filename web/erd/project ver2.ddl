...
CREATE SEQUENCE SEQ_HISTORY START WITH 100 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_ERR_NUM START WITH 100 INCREMENT BY 1 NOCACHE;
...
INSERT INTO TB_WORK_PLAN (PLAN_NUM, CAR_ID, A_ID, P_LOCATION_X, P_LOCATION_Y, PLANNED_TIME) 
		VALUES (SEQ_PLAN.NEXTVAL, 101, 'id01', '37.3688945', '127.3233662', SYSDATE);

##LOAD 업무까지		
INSERT INTO TB_WORK_PLAN (PLAN_NUM, CAR_ID, A_ID, P_LOCATION_X, P_LOCATION_Y, P_LOAD, PLANNED_TIME) 
		VALUES (SEQ_PLAN.NEXTVAL, 201, 'id01', '37.3685641', '127.3235967', '적재', SYSDATE);
...
INSERT INTO TB_WORK_HISTORY (HISTORY_NUM, CAR_ID, PLAN_NUM, WORK_STATUS, START_TIME) 
		VALUES (SEQ_HISTORY.NEXTVAL, 101, 100, '작업 중', SYSDATE);
		
INSERT INTO TB_WORK_HISTORY (HISTORY_NUM, CAR_ID, PLAN_NUM, WORK_STATUS, START_TIME) 
		VALUES (SEQ_HISTORY.NEXTVAL, 201, 101, '작업 중', SYSDATE);
		
#######		
TB_WORK_HISTORY UPDATE SQL

UPDATE TB_WORK_HISTORY SET WORK_STATUS = '작업 완료' ,END_TIME =  SYSDATE WHERE HISTORY_NUM = 100;
UPDATE TB_WORK_HISTORY SET WORK_STATUS = '오류 발생' ,END_TIME =  SYSDATE WHERE HISTORY_NUM = 101;
...
INSERT INTO ERROR_LOG (ERR_NUM, HISTORY_NUM, ERROR_CODE, OCCUR_TIME) 
		VALUES (SEQ_ERR_NUM.NEXTVAL, 101, 11, SYSDATE);
...
INSERT INTO TB_CAR_STATUS (CAR_ID, IGNITION, BATTERY, CHARGE, SPEED) 
				VALUES (101, 'ON', 70, 'OFF', 10);
INSERT INTO TB_CAR_STATUS (CAR_ID, IGNITION, BATTERY, CHARGE, SPEED) 
				VALUES (201, 'OFF', 80, 'OFF', 10);				
